...
public class HostGUI extends JFrame implements Runnable, ActionListener {
	String time = "";
	boolean Act = false;
	Socket s1;
	JPanel contentPane;
	...
	JButton settingButton = new JButton("세부설정");
	...
	public HostGUI(DataOutputStream dos, DataInputStream dis, Socket s1, String nickname) {
		...
		tip.setText(
				"1. \uBC29\uC7A5\uC740 \uAC8C\uC784\uC758 \uB0AE \uC2DC\uAC04, \uBC24 \uC2DC\uAC04, \uC9C1\uC5C5 \uC778\uC6D0 \uC218\uB97C \uC124\uC815\uD558\uACE0, \uAC8C\uC784\uC744 \uC2DC\uC791\uD560 \uC218 \uC788\uB2E4.\r\n \r\n2. \uBCF5\uC0AC \uBD99\uC5EC\uB123\uAE30 (\uC790\uC2E0\uC758 \uC9C1\uC5C5, \uC9C1\uC5C5\uC0C1 \uB728\uB294 \uBB38\uAD6C \uB4F1) \uB294 \uB9E4\uB108\uAC00 \uC544\uB2C8\uB2E4.\r\n\r\n3. \uB3C4\uBC30 \uD22C\uD45C (\uBAA8\uC870\uB9AC \uD639\uC740 \uB9CE\uC740 \uB2E4\uC218\uC5D0\uAC8C \uD22C\uD45C\uD558\uB294 \uAC83) \uB294 \uB9E4\uB108\uAC00 \uC544\uB2C8\uB2E4.");
		...
		settingButton.setBounds(761, 36, 97, 54);
		...
		startButton.setBounds(635, 37, 97, 53);
...
//					}
					...
					if (nickname.equals(str)) {
						skipButton.setEnabled(false);
						killButton.setEnabled(false);
						btnvotestart.setEnabled(false);
						exitButton.setEnabled(false);
						addColoredText(croom, "- 당신은 죽었습니다. -", Color.RED);
						dos.writeUTF("!OK");
					} else 
						addColoredText(croom, "\n- " + str + ". -", Color.RED);
				} else if (strServer.contains("!chat")) {// 서버가 보내는 채팅
